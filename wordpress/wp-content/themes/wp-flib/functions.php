...
function wpeHeaderScripts() {
  if (!is_admin()) {
    ...
    wp_register_script('wpeScripts', get_template_directory_uri() . '/js/vendor.js', array(), '1.0.0', true); // Custom scripts
...
function wpeHeadNavLeft() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul class="nav-header nav-header-left">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
}
function wpeHeadNavRight() {
  wp_nav_menu(
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul class="nav-header nav-header-right">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function wpeSideNavCategory() {
  wp_nav_menu(
  array(
    'theme_location'  => 'sidebar-menu-category',
    'menu'            => '',
    'container'       => 'div',
    'container_class' => 'menu-{menu slug}-container',
    'container_id'    => '',
...
// WPE sidebar navigation
function wpeSideNavFull() {
  wp_nav_menu(
  array(
    'theme_location'  => 'sidebar-menu-full',
    'menu'            => '',
    'container'       => 'div',
    'container_class' => 'menu-{menu slug}-container',
    'container_id'    => '',
...
// WPE sidebar navigation
function wpeSideNavFullTwo() {
  wp_nav_menu(
  array(
    'theme_location'  => 'sidebar-menu-full-two',
    'menu'            => '',
    'container'       => 'div',
    'container_class' => 'menu-{menu slug}-container',
    'container_id'    => '',
...
// WPE sidebar navigation
function wpeSideNavFullThree() {
  wp_nav_menu(
  array(
    'theme_location'  => 'sidebar-menu-full-three',
    'menu'            => '',
    'container'       => 'div',
    'container_class' => 'menu-{menu slug}-container',
    'container_id'    => '',
...
// WPE sidebar navigation
function wpeSideNavFullFour() {
  wp_nav_menu(
  array(
    'theme_location'  => 'sidebar-menu-full-four',
    'menu'            => '',
    'container'       => 'div',
    'container_class' => 'menu-{menu slug}-container',
    'container_id'    => '',
...
function register_html5_menu() {
  register_nav_menus(array(
    'header-menu-left' => __('Меню в шапке слева', 'wpeasy'),
    'header-menu-right' => __('Меню в шапке справа', 'wpeasy'),
    'sidebar-menu' => __('Меню в сайдбар', 'wpeasy'),
    'sidebar-menu-category' => __('Меню в сайдбар категорий', 'wpeasy'),
    'sidebar-menu-full' => __('Меню в сайдбар большой', 'wpeasy'),
    'sidebar-menu-full-two' => __('Меню в сайдбар два', 'wpeasy'),
    'sidebar-menu-full-three' => __('Меню в сайдбар три', 'wpeasy'),
    'sidebar-menu-full-four' => __('Меню в сайдбар четыре', 'wpeasy'),
